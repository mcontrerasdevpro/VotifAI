  ...
  return (
    <div className="space-y-4 shrink-0">
      ...
      <div className="p-3 border border-slate-800 bg-slate-950 rounded-xl shadow-inner">
        <div className="flex items-center gap-1.5 text-5xs font-black text-blue-400 uppercase tracking-widest">
        ...
        <div className="mt-1 flex items-center justify-between gap-2">
          <p className="text-4xs text-slate-500 font-medium truncate">
            {admin ? admin.email_maestro : tenantGlobal?.email || "Conectando con Neon Cloud..."}
          </p>
          <span className="text-5xs font-black text-slate-300 font-mono uppercase truncate">
      ...
      {/* Selector de Fincas */}
      <div>
        <h4 className="text-5xs font-black uppercase tracking-widest text-slate-500 mb-1.5">Fincas en Cartera</h4>
